...
int main()
{
    ...
    // ------------------------------------
    std::filesystem::path lightingVsPath = std::filesystem::current_path().append("multiple_lights.vs");
    std::filesystem::path lightingFsPath = std::filesystem::current_path().append("multiple_lights.fs");
    ...
    // -----------------------------------------------------------------------------
    std::filesystem::path path = std::filesystem::current_path().append("container2.png");
    unsigned int diffuseMap = loadTexture(path.c_str());
    std::filesystem::path path2 = std::filesystem::current_path().append("container2_specular.png");
